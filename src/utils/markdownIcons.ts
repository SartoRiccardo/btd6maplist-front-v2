...
const BADGE_CLASSES =
  "inline-block h-[1.5em] w-[1.5em] rounded-full border-[0.15em] border-(--color-highlight) bg-(--color-primary) object-cover align-middle -translate-y-[0.2rem]";
const ICON_CLASSES =
  "inline-block h-[1.5em] w-[1.5em] object-cover align-middle -translate-y-[0.1rem]";
