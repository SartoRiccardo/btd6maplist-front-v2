...
export const FORMAT_ICONS: FormatIcon[] = [
  {
    id: FORMAT_MAPLIST,
    image: "/images/list_icons/icon_curver.webp",
    name: "Maplist",
    slug: "maplist",
  },
  {
    id: FORMAT_MAPLIST_ALL_VER,
    image: "/images/list_icons/icon_allver.webp",
    name: "All Versions",
    slug: null,
  },
  {
    id: FORMAT_EXPERT_LIST,
    image: "/images/list_icons/icon_hard.webp",
    name: "Expert List",
    slug: "expert-list",
  },
  {
    id: FORMAT_BEST_OF_THE_BEST,
    image: "/images/list_icons/icon_botb.png",
    name: "Best of the Best",
    slug: "best-of-the-best",
  },
  {
    id: FORMAT_NOSTALGIA_PACK,
...
export const FORMATS_WITH_POINTS = [
  FORMAT_MAPLIST,
