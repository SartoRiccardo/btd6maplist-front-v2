...
<template>
  ...
  >
    ...
    >
      ...
      <img
        class="w-full h-auto aspect-[3/2] bg-(--color-primary) block rounded-sm opacity-50 brightness-30 transition-all duration-200 group-hover:opacity-100 group-hover:brightness-100"
